...
# Após 32 unidades de tempo, ele exporta o conteúdo da 4a partição para a pasta.
# Após 48 unidades de tempo, ele baixa a velocidade para a padrão.

after time 16 "type d:compila.bat ; type \\r"
after time 32 "diskmanipulator export hda4 /home/ricardo/MSX/programacao/dev/sandbox"
after time 48 "set speed 100"
